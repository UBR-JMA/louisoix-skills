...
# Trauma-Informed Care for Community Leadership
...
Trauma happens when:
- Something overwhelming occurs (abuse, loss, witnessing violence, systemic oppression, medical crisis, repeated boundary violation)
...
- Accompaniment ("I'm here, you're not alone")
- Skill-building (budgeting, communication, coping strategies)
...
**When crisis happens:**
- "You're safe now" (if true)
- "I'm here. You're not alone."
- "What do you need to feel more safe?"
- "We'll figure this out together."

### What Never to Say

**Never:**
- "Why don't you just...?" (This assumes the solution is simple and they're choosing not to do it)
- "At least..." (This minimizes their experience)
- "You're being too sensitive" (This invalidates their actual experience)
- "I know how you feel" (You don't. You might relate, but you don't know)
- "You should get over this by now" (Healing has no timeline you get to set)
- "You're making this up for attention" (This is gaslighting)
- "Everyone has been through trauma" (This doesn't help anyone)
- "Just think positive" (This won't fix dysregulation)
- "Stop being dramatic" (This shames their response)
- "If you really wanted help, you would..." (This blames them for their own dysregulation)
- "We have to all get along or the community won't survive" (This pressures forgiveness and silence)
- "You need to forgive them" (That's their timeline, not yours to set)

### Practical Approaches for Different Situations

**In a community meeting where someone is escalating:**
1. Pause the meeting
2. Use a calm voice: "I notice we're moving really fast and some energy has shifted. Can we pause?"
3. Address the person directly and privately if possible, or low-key in the room: "What's happening for you right now?"
4. Offer options: "Would you like to step outside? Take a break? Keep talking here?"
5. Don't continue the business meeting until this is addressed
6. Follow up privately after the meeting

**When someone discloses trauma:**
1. Receive it (don't rush to fix or minimize)
2. "Thank you for trusting me with that"
3. "That was a lot. How are you feeling right now?"
4. Don't press for details they're not offering
5. "I'm glad you're safe now" or "You didn't deserve that"
6. "What do you need from me/us going forward?"
7. Follow up later: "I've been thinking about what you shared. How are you doing?"

**When you've made a mistake that hurt someone:**
1. Don't defend yourself first
2. "I hurt you. That wasn't okay."
3. "I understand why you're upset."
4. "Here's what I'm going to do differently."
5. "I want to rebuild trust with you. What would that look like?"
6. Then actually do it

**When someone needs to be held accountable:**
1. Private conversation (not public shaming)
2. Specific behavior: "When you said X, it had this impact on me/this person/the community"
3. Not character attack: "You did something harmful. You're not a bad person."
4. Understanding: "Help me understand what led to that"
5. Path forward: "Here's what needs to happen. Here's how we'll know you're serious about change."
6. Ongoing: "How's the repair process going? What support do you need?"

**When the community is struggling as a whole:**
1. Name it together: "We're in a hard place. We're all feeling it."
2. Create time to process (not just fix)
3. Acknowledge limits: "We can't solve this in one meeting"
4. Distribute the work: "What does each person need to bring to this?"
5. Build in recovery: "We're taking next Saturday off"
6. Remember purpose: "Why do we do this? What brought us together?"

## Creating Traumasafe Community Environments

This is the infrastructure that makes all the principles work.

### Physical Space

- Multiple exits (never a trapped feeling)
- Ability to adjust lighting, temperature, sound
- Seating options (sitting, standing, on the ground, against a wall, near the door)
- Quiet space available if someone needs to step back
- Accessibility considered (wheelchair access, lactation room, prayer space, sensory quiet room)
- No surprises about what's happening or where
