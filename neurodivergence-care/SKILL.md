---
name: neurodivergence-care
description: |
  Neurodivergence-informed advisory for community stewards working with autistic, ADHD, and AuDHD community members. Covers: autism (sensory access, communication differences, meltdowns vs. shutdowns, monotropism, special interests, masking and its cost), ADHD (executive dysfunction, time blindness, rejection sensitive dysphoria, hyperfocus), the AuDHD intersection, and late diagnosis identity processing.
  
    Activate when a community member's neurology is shaping how they engage — meeting participation, communication style, overwhelm responses, task completion, sensory comfort. Also activate when structural changes would make community more accessible to neurodivergent members, or when a member has received (or is seeking) a late diagnosis.
  
    Key orientation: structural support over coaching. Never suggest masking, social skills training, or 'trying harder.' Design the environment for the member.
---

# Neurodivergence-Informed Care

## The Foundational Frame: Difference, Not Deficit
...
## Autism: Deep Framework

### Sensory Experience and Access
...
- Lower lighting options, including the ability to turn off some overhead lights
- Quieter breakout spaces or alternative participation locations
- Advance notice of agenda and sensory conditions ("this will be a loud room, here's what the quieter option is")
- Permission to leave and return without social penalty or explanation
- Unscented or lightly scented environments for shared gatherings
- Predictable physical layouts rather than constantly rearranged furniture
...
### Executive Function Is Neurological, Not Motivational
...
- They may have the social motivation that contradicts the stereotype of autism (often present in those with ADHD, which the autistic component can mask)
- They may appear to have better focus than "typical" ADHD because autistic monotropism and ADHD hyperfocus can work together — until they crash into avoidance
- The autistic pattern-seeking and the ADHD need for novelty can produce someone who deeply understands systems while constantly wanting to redesign them
- They may be highly verbal and analytically skilled (masking via intellectual performance) while simultaneously struggling with the most basic executive tasks
...
## Community Participation and Consensus Governance
...
## Practical Community Design Checklist
