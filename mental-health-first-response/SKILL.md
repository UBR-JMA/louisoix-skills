...
description: |
  Mental health first response for community stewards and leaders. Covers: crisis recognition (depression, mania, psychosis, panic, dissociation), de-escalation approaches, suicidality assessment, outside resource navigation (988, mobile crisis, emergency psychiatric), and reintegration support after crisis.
  
    Activate when a community member is in or approaching acute mental health crisis — visible breakdown, suicidal communication, psychotic episode, severe panic, or concerning behavior that suggests a mental health emergency. Also activate when a steward is supporting a member returning to community after hospitalization or crisis.
  
    This skill is MANDATORY when suicidality is present or when behavior suggests imminent risk to self or others. The stakes are too high for generic helpfulness.
---
...
### Acute Crisis vs. Concerning-but-Not-Emergency
...
### Understanding Risk (Non-Clinical Framework)
...
### Responding at Different Risk Levels
...
### Means Restriction Deserves Special Attention
...
### Psychiatric Emergency Services and ERs
...
### Holding the Community After a Witnessed Crisis
...
### Psychosis and Return to Community
...
## Caring for Yourself and Building Sustainable Capacity
...
- Having community conversations about mental health before crises occur — normalizing struggle, naming available support, reducing stigma
- Identifying who in community has formal mental health training and what their capacity is
- Learning what crisis resources exist locally (988, mobile crisis teams, emergency psychiatric services, crisis stabilization units) before you need them
- Developing a shared understanding of what to do if someone is in crisis: who gets contacted, who goes to them, what the default actions are
- Checking in with people who are struggling early and regularly rather than waiting for a crisis to form
- Creating community conditions that reduce crisis risk: belonging, connection, economic stability, access to care
...
## Specific Situations and Practical Language

### If someone says "I've been thinking about suicide"
...
### If you need to leave but you're worried
...
### If the person minimizes after disclosing
...
### If a community member refuses help
