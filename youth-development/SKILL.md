...
- Adults decide others (fundamental safety policies, budget allocation, hiring/membership decisions)
...
1. **If you suspect a child is being harmed by a parent/caregiver:**
...
2. **If you suspect a child is being harmed by a community member:**
...
3. **If a child discloses harm to you:**
...
- Stability (predictable meals, safe space, regular people)
...
1. **Adults must intervene immediately.** Not "let them work it out." Not ignore it hoping it goes away. Bullying requires adult action.

2. **Protect the target.** Remove them from situations where bullying occurs. Create safe spaces. Assign an adult to check in. Do not force them to "be brave" or "ignore it."

3. **Address the bullying behavior.** Talk to the child doing the bullying. Understand what's going on (sometimes children bully because they're being hurt elsewhere). Set clear consequences. Require repair (apology, behavior change, restitution).

4. **Work with bystanders.** Children who witness bullying but don't stop it are supporting it. Help them understand they can intervene ("That's not cool," moving to stand by the target, telling an adult).

5. **Monitor.** Check whether the bullying has actually stopped. Often adults address it once and assume it's handled; bullying then goes underground.

6. **Don't exile the bullying child.** The goal is behavior change, not permanent banishment. But the target's safety comes first. You can include the child doing the bullying *after* they've shown sustained behavior change and genuinely repaired harm.
...
- Teach skills directly (cooking, gardening, building, music, art)
- Answer questions deeply and seriously
...
**What's surveillance vs. reasonable oversight:**
- Surveillance: GPS tracking, hidden cameras, reading diaries, surprise locker searches, monitoring texts
